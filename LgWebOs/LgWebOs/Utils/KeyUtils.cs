...
namespace LgWebOs.Utils
{
    public class KeyUtils
    {
        private const string GET_CLIENT_KEY =
        ...
        private const string VERIFY_CLIENT_KEY =
            "{{\"type\":\"register\",\"id\":\"register_1\",\"payload\":{{\"client-key\":\"{0}\"}}}}";

        public static string GetVerifyClientKey(string clientKey)
        {
            return string.IsNullOrEmpty(clientKey) ? GET_CLIENT_KEY : string.Format(VERIFY_CLIENT_KEY, clientKey);
        }
    }
}